 ...
 * be used to free memory as well as to check thread_complete_success for successful exit. If a
 * thread was started succesfully @param thread should be filled with the pthread_create thread ID
